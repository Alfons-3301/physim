...
from channels.baseChannels import BinarySymmetricChannel, AWGNChannel
from modulation.baseModulation import BPSKModulation
...
def simulation_worker(data_queue):
    ...
    channel_bob = AWGNChannel(snr_bob)
    channel_eve = AWGNChannel(snr_eve)
